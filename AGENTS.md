...
This repository is an intentionally parked product idea. Read README.md, docs/VISION.md and docs/PLANNING.md before proposing or implementing work.
...
- Manual play is the initial product direction. Forge adoption, production stack, identity model, licensing and release scope remain undecided.
